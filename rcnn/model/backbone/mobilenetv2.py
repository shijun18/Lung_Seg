...
class MobileNetV2(nn.Module):
    def __init__(self, n_channels=1, num_classes=1000, output_stride=8, width_mult=1.0, inverted_residual_setting=None, round_nearest=8):
        """
        ...
        features = [ConvBNReLU(n_channels, input_channel, stride=2)]
        current_stride *= 2
        dilation=1
        previous_dilation = 1
        ...
        self.classifier = nn.Sequential(
            nn.Dropout(0.2),
            nn.Linear(self.last_channel, num_classes-1),
        )
